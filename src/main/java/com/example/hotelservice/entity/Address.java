...
public class Address {
    ...
    public Address(Long id, Integer houseNumber, String street, String city, String country, String postCode) {
        this.id = id;
    ...
    public static class Builder {
        ...
        public Address build() { return new Address(id, houseNumber, street, city, country, postCode); }
    }
